...
public class AppDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder mb)
    {
        ...
        const string defaultHash = "$2a$11$rBnNPbDsKB5xU2xW7QkY8OqKzLGfM3pN9vXwYhJdR4sT6eA1iC2Gu";
        var users = new List<User>
        {
            new() { Id=1, FullName="Alice Johnson", Email="alice@example.com", PhoneNumber="555-0101", Username="alice", Role=UserRole.Admin, Status=UserStatus.Active,   PasswordHash=defaultHash, IsEmailVerified=true, CreatedAt=new DateTime(2024,1,1,0,0,0,DateTimeKind.Utc) },
            new() { Id=2, FullName="Bob Martinez",  Email="bob@example.com",   PhoneNumber="555-0102", Username="bob",   Role=UserRole.User,  Status=UserStatus.Active,   PasswordHash=defaultHash, IsEmailVerified=true, CreatedAt=new DateTime(2024,1,2,0,0,0,DateTimeKind.Utc) },
            new() { Id=3, FullName="Carol White",   Email="carol@example.com", PhoneNumber="555-0103", Username="carol", Role=UserRole.User,  Status=UserStatus.Inactive, PasswordHash=defaultHash, IsEmailVerified=true, CreatedAt=new DateTime(2024,1,3,0,0,0,DateTimeKind.Utc) },
            new() { Id=4, FullName="David Lee",     Email="david@example.com", PhoneNumber="555-0104", Username="david", Role=UserRole.User,  Status=UserStatus.Active,   PasswordHash=defaultHash, IsEmailVerified=true, CreatedAt=new DateTime(2024,1,4,0,0,0,DateTimeKind.Utc) },
            new() { Id=5, FullName="Emma Davis",    Email="emma@example.com",  PhoneNumber="555-0105", Username="emma",  Role=UserRole.User,  Status=UserStatus.Suspended,PasswordHash=defaultHash, IsEmailVerified=true, CreatedAt=new DateTime(2024,1,5,0,0,0,DateTimeKind.Utc) },
        };
